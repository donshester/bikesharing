...
export class InitTables1692567428042 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "drives" ("id" SERIAL NOT NULL, "startTime" TIMESTAMP NOT NULL, "endTime" TIMESTAMP, "cost" numeric(10,2), "userId" uuid, "bikeId" integer, CONSTRAINT "PK_bae73130c1430cebac87a775037" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."bikes_status_enum" AS ENUM('Serviceable', 'OutOfOrder')`,
    );
    await queryRunner.query(
